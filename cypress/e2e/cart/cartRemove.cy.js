describe('Cart feature', () => {
    ...
    it('Should remove the product from the cart', () => {
      cy.fixture('login').then((user) => {
        ...
        cart.checkfield("button")("contain.text")("Add to cart")
        cart.buttonClick("button")("Add to cart");
        cy.get(".shopping_cart_badge").invoke("text").then((text) => {
            expect(Number(text)).to.be.greaterThan(0);
          });
        cy.get(".shopping_cart_badge").click();
        cart.checkfield(".inventory_item_name")("contain.text")("Sauce Labs Bolt T-Shirt");
        cart.checkfield("button")("contain.text")("Remove");
        cart.buttonClick("button")("Remove");
        cart.checkfield(".inventory_item_name")("not.exist")("Sauce Labs Bolt T-Shirt");
      });
    }); 
  });